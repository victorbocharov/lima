...
int main(int argc, char **argv)
{
  ...
  std::string limaNLPServerConfigFile;
  ...
  ("common-config-file", po::value<std::string>(&limaNLPServerConfigFile)->default_value("lima-NLPServer.xml"),
  ...
  // Parse configuration file of limaNLPServer
  ...
  LimaNLPServer server( configDir, langs, pipes, port, &app, &t);
